...
extern int showstack      = 0;  /* print the stack pointer (for debugging)         */
extern int showstatistics = 0;
extern int printworms     = 0;  /* print full data about each string on the board  */
extern int printmoyo      = 0;  /* print moyo board each move                      */
extern int allpats        = 0;  /* compute and print value of all patterns.        */
